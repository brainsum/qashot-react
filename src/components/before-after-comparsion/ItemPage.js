  ...
  renderTestHeader() {
    ...
    return (<div className="test-info-header">
      <div className="result">
        <div className="success">Passed <span className="passed-number">{isDataAfter ? metadata_lifetimes[lastRunAfter].passed_count : "?"}</span></div>
        <div className="failed">Failed <span className="failed-number">{isDataAfter ? metadata_lifetimes[lastRunAfter].failed_count : "?"}</span></div>
      </div>
                ...
                <div className="scenario-info">
                  ...
                  <div className="urls row">
                    <div className="url2 col-lg-5">
                      <div className="url2-title">URL</div>
          ...
          return (
            <div key={i}>
              <div className="scenario-info">
                ...
                <div className="row">
                  <div className="col-lg-8">{scenario.field_test_url}</div>
...
const mapStateToProps = (state, props) => {
  return {
    ...
    viewports: state.entities.viewports,
    message: state.test.message,
    sMessage: state.test.successMessage,
    error: state.test.error,
    testIsRunning: state.test.testIsRunning,
    queue: state.entities.queue,
  };
}

const BeforeAfterComparsionItemPageContainer = connect(mapStateToProps)(BeforeAfterComparsionItemPage);

export default BeforeAfterComparsionItemPageContainer;
